...
from app.models import EventType, Stream, StreamEvent, StreamStatus
...
class TestStreamProbeResult:
    ...
    def test_default_values(self):
        ...
        result = StreamProbeResult(is_healthy=True, status=StreamStatus.HEALTHY)
...
class TestHealthChecker:
    ...
    def test_quick_check_node_success(
        self,
        app_context,
        db_session,
        sample_node,
    ...
    def test_quick_check_node_api_error(
    ...
    def test_quick_check_node_connection_error(
        self, app_context, db_session, sample_node, mock_httpx
    ):
    ...
    def test_quick_check_all_nodes(
    ...
    def test_analyze_probe_result_healthy(self, app_context, ffprobe_response):
        ...
        result = checker._analyze_probe_result(
            ffprobe_response, "rtsp://localhost:8554/test", "rtsp"
        )
    ...
    def test_analyze_probe_result_no_streams(self, app_context):
        ...
        checker = HealthChecker()
        result = checker._analyze_probe_result(
            {"streams": [], "format": {}}, "rtsp://localhost:8554/test", "rtsp"
        )
    ...
    def test_analyze_probe_result_low_fps(self, app_context):
        ...
        result = checker._analyze_probe_result(
            probe_data, "rtsp://localhost:8554/test", "rtsp"
        )
    ...
    def test_probe_url_success(self, app_context, mock_subprocess, ffprobe_response):
        ...
        mock_subprocess["run"].return_value = MagicMock(
            returncode=0, stdout=json.dumps(ffprobe_response), stderr=""
        )
    ...
    def test_probe_stream_success(
        self, app_context, db_session, sample_stream, mock_subprocess, ffprobe_response
    ):
    ...
    def test_probe_stream_creates_event_on_status_change(
        self,
        app_context,
        db_session,
    ...
    def test_get_all_streams_health(
        self, app_context, db_session, sample_stream, sample_unhealthy_stream
    ):
    ...
    def test_get_all_streams_health_filtered_by_status(
        self, app_context, db_session, sample_stream, sample_unhealthy_stream
    ):
    ...
    def test_get_all_streams_health_filtered_by_node(
    ...
    def test_detect_black_screen_no_black(self, app_context, mock_subprocess):
        ...
        mock_subprocess["run"].return_value = MagicMock(
            returncode=0, stdout="", stderr="frame=60 fps=30"
        )
    ...
    def test_detect_freeze_no_freeze(self, app_context, mock_subprocess):
        ...
        mock_subprocess["run"].return_value = MagicMock(
            returncode=0, stdout="", stderr="frame=150 fps=30"
        )
    ...
    def test_detect_audio_silence(self, app_context, mock_subprocess):
        ...
        mock_subprocess["run"].return_value = MagicMock(
            returncode=0, stdout="", stderr="[silencedetect @ 0x...] silence_start: 0"
        )
    ...
    def test_detect_audio_silence_no_silence(self, app_context, mock_subprocess):
        ...
        mock_subprocess["run"].return_value = MagicMock(
            returncode=0, stdout="", stderr="size=N/A time=00:00:03"
        )
    ...
    def test_measure_fps_no_frames(self, app_context, mock_subprocess):
        ...
        mock_subprocess["run"].return_value = MagicMock(
            returncode=0,
            stdout=json.dumps({"streams": [{"nb_read_frames": "0"}]}),
            stderr="",
        )
